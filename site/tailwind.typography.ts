...
type Typography = {
  ...
  invert: Record<string, any>
}

export const typography = (theme: (setting: string) => string): Typography => ({
  invert: {
    css: {
      ...
      "--tw-prose-pre-bg": "var(--tw-prose-code-bg)",
  ...
  DEFAULT: {
    css: {
      ...
      // "li.task-list-item > input:disabled": {
      //   accentColor: "#0000ff",
      // },
