...
There are some APIs that I use very often. Object.assign is one of them. The use case for me is
almost always constructing a new object by merging various properties. Here are the basics:
...
There are a couple of aspects that make this method useful. We can for example set a default value
of a field and then overwrite it:
...
Overall I use this API as a safety net. Especially in the cases where data is missing or is
incomplete.
