...
let Documentary = (() => {
  ...
  return (
    (_a = class Documentary extends _classSuper {
    ...
    (() => {
      ...
      const _metadata =
        typeof Symbol === "function" && Symbol.metadata
          ? Object.create((_b = _classSuper[Symbol.metadata]) !== null && _b !== void 0 ? _b : null)
          : void 0
      _printItem_decorators = [decorators_1.logMethodInfo]
      __esDecorate(
        _a,
        null,
        _printItem_decorators,
        {
          kind: "method",
          name: "printItem",
          static: false,
          private: false,
          access: { has: (obj) => "printItem" in obj, get: (obj) => obj.printItem },
          metadata: _metadata,
        },
        null,
